      ...
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-16">
        ...
        >
          ...
          <p className="text-xl text-[#5D4037]/80">
            Start with 20 free minutes. Then pay as you go.
          </p>
        </motion.header>
          ...
          <Card className="bg-white/90 backdrop-blur-sm shadow-lg border-0 rounded-2xl overflow-hidden">
            <CardContent className="p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-[#5D4037]/80 mt-2">per hour of tutoring</p>
              </div>
        ...
        >
          <Card className="bg-white/80 backdrop-blur-sm shadow-lg border-0 rounded-2xl">
            <CardContent className="p-8">
              <h2 className="text-2xl font-semibold text-[#8B4513] mb-6">Compare with traditional tutoring</h2>
              
              <div className="mb-8">
                <div className="flex justify-between items-center mb-4">
                  <p className="text-[#5D4037]">Hours per month</p>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center p-4 rounded-xl bg-[#8B4513]/5">
                  <p className="text-[#8B4513] mb-2">Poppa AI</p>
                  <p className="text-3xl font-bold text-[#8B4513]">${(poppaPrice * hoursPerMonth).toFixed(2)}</p>
                </div>
                <div className="text-center p-4 rounded-xl bg-[#8B4513]/5">
                  <p className="text-[#8B4513] mb-2">Traditional Tutor</p>
